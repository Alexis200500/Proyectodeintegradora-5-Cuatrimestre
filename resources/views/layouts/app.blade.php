                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{ route('login') }}"><i class="fas fa-power-off mr-2"></i>Cerrar Sesión</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('consultausu') }}"><i class="fa fa-fw fa-user-circle"></i>Usuarios <span class="badge badge-success"></span>
                                </a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultacli') }}"><i class="fa fa-fw fa-rocket"></i>Clientes</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultaemp') }}" ><i class="fas fa-fw fa-chart-pie"></i>Empleados</a>

                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{ route('consultapro') }}"><i class="fab fa-fw fa-wpforms"></i>Productos</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('consultaven') }}" ><i class="fas fa-fw fa-table"></i>Ventas</a>
